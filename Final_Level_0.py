...
def main():
    ...
    tmx_data = load_pygame("Final_map.tmx")
    ...
    x = 0
    y = y_ground
    world_offset = [-100,-9700]    #base(-100, -9700) (-5400, -9700)
    R_G = 1
    ...
    while not quit:
        ...
        if touching_locks_keys_rightside["require"] in collected_items:
            ...
            if item == "green key":
                tmx_data.layers[0].data[touching_locks_keys_rightside["y"]][touching_locks_keys_rightside["x"]] = 0
                tmx_data.layers[0].data[295][162] = tmx_data.layers[1].data[295][162]
                tmx_data.layers[0].data[296][162] = tmx_data.layers[1].data[296][162]
                next_level.play()
                time = 40
        ...
        if standing_on_left["id"] == 258 or standing_on_right["id"] == 258:
            tmx_data.layers[0].data[192][166] = 0
            tmx_data.layers[0].data[192][166] = tmx_data.layers[1].data[192][166]
            level_Complete.play()
            end_S0 = 1
